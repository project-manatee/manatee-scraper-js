...
TEAMSParser.NUMERIC_REGEX = function() { return /(\d+)/g };
TEAMSParser.EXTRA_CREDIT_REGEX = function () { return /^extra credit$|^ec$/ig };
TEAMSParser.EXTRA_CREDIT_NOTE_REGEX = function () { return /extra credit/ig };
